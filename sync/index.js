...
const CONTAINER_GOOGLE_PK = process.env.CONTAINER_GOOGLE_PK;
const CONTAINER_GOOGLE_PK_ID = process.env.CONTAINER_GOOGLE_PK_ID;
...
this.initialise = async()=>{
	...
	auth = new google.auth.JWT(credentials.client_email, null, credentials.private_key, ['https://www.googleapis.com/auth/drive','https://www.googleapis.com/auth/drive.file','https://www.googleapis.com/auth/drive.metadata']);
	auth.authorize();
